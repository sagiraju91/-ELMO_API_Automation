...
using MobileAppAutomation.configurations;
...
namespace MobileAppAutomation.Hooks
{
    [Binding]
    public class Setup
    {
        ...
        public void BeforeScenario()
        {
            ...
            if (_appName.ToLower() == "androidapp")
            {
                AndroidDriverHelper _appiumAndroid = new AndroidDriverHelper(_scenarioContext);
                _scenarioContext.Set(_appiumAndroid, "AndroidDriver");


            }

            else if (_appName.ToLower() == "iosapp")
            {
                IOSDriverHelper _appiumIOS = new IOSDriverHelper(_scenarioContext);
                _scenarioContext.Set(_appiumIOS, "iOSDriver");
            }
        ...
        public void AfterScenario()
        {
            if (_appName.ToLower() == "androidapp")
            {
                ...
                _scenarioContext.Get<AndroidDriver<AndroidElement>>("AndroidDriver").Quit();
                
            }
            else if (_appName.ToLower() == "iosapp")
            {
                _scenarioContext.Get<IOSDriver<IOSElement>>("iOSDriver").Quit();
            }
            else
                Console.WriteLine("No App Name found !!!");
